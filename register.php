...
if(isset($_POST['register'])){
    ...
    $sql = "INSERT INTO users(username, password, role, email, phone) VALUES('$u', '$p', 'user', '$e', '$ph')";
    if($conn->query($sql)){
...
<head>
<meta charset="UTF-8">
<title>Register | Citizen Connect</title>
...
<div class="login-box">
    ...
    <form method="POST">
        <div class="input-box">
            ...
            <input name="username" placeholder="Full Name / Username" required>
        </div>
        <div class="input-box">
        ...
        <button name="register">Register Now <i class="fas fa-user-check" style="margin-left: 5px;"></i></button>
    </form>
