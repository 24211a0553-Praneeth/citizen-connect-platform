...
if(isset($_POST['login'])){
    ...
    $res = $conn->query("SELECT * FROM users WHERE username='$u' AND password='$p' AND role='admin'");
...
<html>
<head>
<title>Admin Login - Citizen Connect</title>
...
<div class="login-box">
    ...
    <?php if(isset($msg)) echo "<div class='msg'><i class='fas fa-exclamation-triangle'></i> $msg</div>"; ?>
